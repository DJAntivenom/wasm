#ifndef __WASM_GLOBAL_SECTION_DECODER_HPP__
#define __WASM_GLOBAL_SECTION_DECODER_HPP__
 ...
 */
class GlobalSectionDecoder : public virtual SectionDecoder
{
public:
    GlobalSectionDecoder() : SectionDecoder(static_cast<SectionID>(6)) {};
